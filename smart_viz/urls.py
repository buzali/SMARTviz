...
urlpatterns = patterns('',
    ...
    url(r'^events/fbtest?', 'events.views.fb_test'),
    ...
    url(r'^related/createEvent/(?P<myCalendarId>[^\/]+)', 'related.views.createEvent'),
    url(r'^related/deleteEvent/(?P<eventId>[^\/]+)/(?P<myCalendarId>[^\/]+)', 'related.views.deleteEvent'),
    url(r'^related/getCalendarId/(?P<myUserId>[^\/]+)', 'related.views.getTheCalendarForUser'),
